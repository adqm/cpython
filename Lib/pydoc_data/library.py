...
# generated on Tue Aug 12 18:29:44 2025.
...
ABCs.)''',
    'aifc': r'''aifc is no longer part of the Python standard library. It was removed
...
programmatically what the current grammar looks like.''',
    'asynchat': r'''asynchat is no longer part of the Python standard library. It was
...
and Tasks.''',
    'asyncore': r'''asyncore is no longer part of the Python standard library. It was
removed in Python 3.12 after being deprecated in Python 3.6.  The
removal was decided in **PEP 594**.
...
be run in the order "C", "B", "A".''',
    'audioop': r'''audioop is no longer part of the Python standard library. It was
...
"time" modules.''',
    'cgi': r'''cgi is no longer part of the Python standard library. It was removed
in Python 3.13 after being deprecated in Python 3.11.  The removal was
decided in **PEP 594**.
...
3.12.''',
    'cgitb': r'''cgitb is no longer part of the Python standard library. It was removed
in Python 3.13 after being deprecated in Python 3.11.  The removal was
decided in **PEP 594**.
...
3.12.''',
    'chunk': r'''chunk is no longer part of the Python standard library. It was removed
in Python 3.13 after being deprecated in Python 3.11.  The removal was
decided in **PEP 594**.
...
instances.''',
    'crypt': r'''crypt is no longer part of the Python standard library. It was removed
in Python 3.13 after being deprecated in Python 3.11.  The removal was
decided in **PEP 594**.
...
server, or without any index server at all.''',
    'distutils': r'''distutils is no longer part of the Python standard library. It was
...
servers, but note that the "STATUS" command is not supported in IMAP4.''',
    'imghdr': r'''imghdr is no longer part of the Python standard library. It was
removed in Python 3.13 after being deprecated in Python 3.11.  The
removal was decided in **PEP 594**.
...
Python 3.12.''',
    'imp': r'''imp is no longer part of the Python standard library. It was removed
in Python 3.12 after being deprecated in Python 3.4.
...
formats are Maildir, mbox, MH, Babyl, and MMDF.''',
    'mailcap': r'''mailcap is no longer part of the Python standard library. It was
removed in Python 3.13 after being deprecated in Python 3.11.  The
removal was decided in **PEP 594**.
...
printed.''',
    'msilib': r'''msilib is no longer part of the Python standard library. It was
removed in Python 3.13 after being deprecated in Python 3.11.  The
removal was decided in **PEP 594**.
...
by the Unix **ftp** program and other FTP clients.''',
    'nis': r'''nis is no longer part of the Python standard library. It was removed
in Python 3.13 after being deprecated in Python 3.11.  The removal was
decided in **PEP 594**.

The last version of Python that provided the "nis" module was Python
3.12.''',
    'nntplib': r'''nntplib is no longer part of the Python standard library. It was
removed in Python 3.13 after being deprecated in Python 3.11.  The
removal was decided in **PEP 594**.
...
or any object implementing the "os.PathLike" protocol.''',
    'ossaudiodev': r'''ossaudiodev is no longer part of the Python standard library. It was
removed in Python 3.13 after being deprecated in Python 3.11.  The
removal was decided in **PEP 594**.
...
probably won’t find the "pickletools" module relevant.''',
    'pipes': r'''pipes is no longer part of the Python standard library. It was removed
in Python 3.13 after being deprecated in Python 3.11.  The removal was
decided in **PEP 594**.
...
option.''',
    'smtpd': r'''smtpd is no longer part of the Python standard library. It was removed
in Python 3.12 after being deprecated in Python 3.6.  The removal was
decided in **PEP 594**.
...
Service Extensions).''',
    'sndhdr': r'''sndhdr is no longer part of the Python standard library. It was
removed in Python 3.13 after being deprecated in Python 3.11.  The
removal was decided in **PEP 594**.
...
servers.''',
    'spwd': r'''spwd is no longer part of the Python standard library. It was removed
in Python 3.13 after being deprecated in Python 3.11.  The removal was
decided in **PEP 594**.
...
module intends to replace several older modules and functions:''',
    'sunau': r'''sunau is no longer part of the Python standard library. It was removed
in Python 3.13 after being deprecated in Python 3.11.  The removal was
decided in **PEP 594**.
...
functions in shutil.''',
    'telnetlib': r'''telnetlib is no longer part of the Python standard library. It was
removed in Python 3.13 after being deprecated in Python 3.11.  The
removal was decided in **PEP 594**.
...
http://www.robotstxt.org/orig.html.''',
    'uu': r'''uu is no longer part of the Python standard library. It was removed in
Python 3.13 after being deprecated in Python 3.11.  The removal was
decided in **PEP 594**.
...
supports WSGI with a number of different web servers.''',
    'xdrlib': r'''xdrlib is no longer part of the Python standard library. It was
removed in Python 3.13 after being deprecated in Python 3.11.  The
removal was decided in **PEP 594**.
