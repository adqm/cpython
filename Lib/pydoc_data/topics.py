# Autogenerated by Sphinx on Thu Aug 14 23:06:56 2025
...
library = {
    '__future__': (True,
r'''Imports of the form "from __future__ import feature" are called future
...
'''),
    '_thread': (True,
r'''This module provides low-level primitives for working with multiple
...
'''),
    'abc': (True,
r'''This module provides the infrastructure for defining *abstract base
...
'''),
    'aifc': (False,
r'''aifc is no longer part of the Python standard library. It was removed
...
'''),
    'annotationlib': (True,
r'''The "annotationlib" module provides tools for introspecting
*annotations* on modules, classes, and functions.

'''),
    'argparse': (True,
r'''While "argparse" is the default recommended standard library module
...
'''),
    'array': (True,
r'''This module defines an object type which can compactly represent an
...
'''),
    'ast': (True,
r'''The "ast" module helps Python applications to process trees of the
...
'''),
    'asynchat': (False,
r'''asynchat is no longer part of the Python standard library. It was
...
'''),
    'asyncio': (True,
r'''asyncio is a library to write **concurrent** code using the
**async/await** syntax.

'''),
    'asyncio-api-index': (True,
r'''This page lists all high-level async/await enabled asyncio APIs.

'''),
    'asyncio-dev': (True,
r'''Asynchronous programming is different from classic “sequential”
programming.

'''),
    'asyncio-eventloop': (True,
r'''The event loop is the core of every asyncio application. Event loops
run asynchronous tasks and callbacks, perform network IO operations,
and run subprocesses.

'''),
    'asyncio-exceptions': (True,
r'''A deprecated alias of "TimeoutError", raised when the operation has
exceeded the given deadline.

'''),
    'asyncio-extending': (True,
r'''The main direction for "asyncio" extending is writing custom *event
loop* classes. Asyncio has helpers that could be used to simplify this
task.

'''),
    'asyncio-future': (True,
r'''*Future* objects are used to bridge **low-level callback-based code**
with high-level async/await code.

'''),
    'asyncio-graph': (True,
r'''asyncio has powerful runtime call graph introspection utilities to
...
'''),
    'asyncio-llapi-index': (True,
r'''This page lists all low-level asyncio APIs.

'''),
    'asyncio-platforms': (True,
r'''The "asyncio" module is designed to be portable, but some platforms
have subtle differences and limitations due to the platforms’
underlying architecture and capabilities.

'''),
    'asyncio-policy': (True,
r'''Policies are deprecated and will be removed in Python 3.16. Users are
encouraged to use the "asyncio.run()" function or the "asyncio.Runner"
with *loop_factory* to use the desired loop implementation.

'''),
    'asyncio-protocol': (True,
r'''Transports and Protocols are used by the **low-level** event loop APIs
...
'''),
    'asyncio-queue': (True,
r'''asyncio queues are designed to be similar to classes of the "queue"
module.  Although asyncio queues are not thread-safe, they are
designed to be used specifically in async/await code.

'''),
    'asyncio-runner': (True,
r'''This section outlines high-level asyncio primitives to run asyncio
code.

'''),
    'asyncio-stream': (True,
r'''Streams are high-level async/await-ready primitives to work with
network connections.  Streams allow sending and receiving data without
using callbacks or low-level protocols and transports.

'''),
    'asyncio-subprocess': (True,
r'''This section describes high-level async/await asyncio APIs to create
and manage subprocesses.

'''),
    'asyncio-sync': (True,
r'''asyncio synchronization primitives are designed to be similar to those
...
'''),
    'asyncio-task': (True,
r'''This section outlines high-level asyncio APIs to work with coroutines
and Tasks.

'''),
    'asyncore': (False,
r'''asyncore is no longer part of the Python standard library. It was
removed in Python 3.12 after being deprecated in Python 3.6.  The
removal was decided in **PEP 594**.
...
'''),
    'atexit': (True,
r'''The "atexit" module defines functions to register and unregister
...
'''),
    'audioop': (False,
r'''audioop is no longer part of the Python standard library. It was
...
'''),
    'audit_events': (True,
r'''This table contains all events raised by "sys.audit()" or
...
'''),
    'base64': (True,
r'''This module provides functions for encoding binary data to printable
...
'''),
    'bdb': (True,
r'''The "bdb" module handles basic debugger functions, like setting
breakpoints or managing execution via the debugger.

'''),
    'binascii': (True,
r'''The "binascii" module contains a number of methods to convert between
...
'''),
    'bisect': (True,
r'''This module provides support for maintaining a list in sorted order
...
'''),
    'builtins': (True,
r'''This module provides direct access to all ‘built-in’ identifiers of
Python; for example, "builtins.open" is the full name for the built-in
function "open()".

'''),
    'bz2': (True,
r'''This module provides a comprehensive interface for compressing and
decompressing data using the bzip2 compression algorithm.

'''),
    'calendar': (True,
r'''This module allows you to output calendars like the Unix **cal**
...
'''),
    'cgi': (False,
r'''cgi is no longer part of the Python standard library. It was removed
in Python 3.13 after being deprecated in Python 3.11.  The removal was
decided in **PEP 594**.
...
'''),
    'cgitb': (False,
r'''cgitb is no longer part of the Python standard library. It was removed
in Python 3.13 after being deprecated in Python 3.11.  The removal was
decided in **PEP 594**.
...
'''),
    'chunk': (False,
r'''chunk is no longer part of the Python standard library. It was removed
in Python 3.13 after being deprecated in Python 3.11.  The removal was
decided in **PEP 594**.
...
'''),
    'cmath': (True,
r'''This module provides access to mathematical functions for complex
...
'''),
    'cmd': (True,
r'''The "Cmd" class provides a simple framework for writing line-oriented
...
'''),
    'cmdline': (True,
r'''The following modules have a command-line interface.

'''),
    'code': (True,
r'''The "code" module provides facilities to implement read-eval-print
...
'''),
    'codecs': (True,
r'''This module defines base classes for standard Python codecs (encoders
...
'''),
    'codeop': (True,
r'''The "codeop" module provides utilities upon which the Python read-
...
'''),
    'collections': (True,
r'''This module implements specialized container datatypes providing
alternatives to Python’s general purpose built-in containers, "dict",
"list", "set", and "tuple".

'''),
    'collections.abc': (True,
r'''This module provides *abstract base classes* that can be used to test
whether a class provides a particular interface; for example, whether
it is *hashable* or whether it is a *mapping*.

'''),
    'colorsys': (True,
r'''The "colorsys" module defines bidirectional conversions of color
...
'''),
    'compileall': (True,
r'''This module provides some utility functions to support installing
...
'''),
    'compression': (True,
r'''The "compression" package contains the canonical compression modules
...
r'''This module provides classes and functions for compressing and
...
'''),
    'concurrent': (True,
r'''This package contains the following modules:
...
r'''The "concurrent.futures" module provides a high-level interface for
asynchronously executing callables.

'''),
    'concurrent.interpreters': (True,
r'''The "concurrent.interpreters" module constructs higher-level
interfaces on top of the lower level "_interpreters" module.

'''),
    'configparser': (True,
r'''This module provides the "ConfigParser" class which implements a basic
...
'''),
    'constants': (True,
r'''A small number of constants live in the built-in namespace.  They are:

'''),
    'contextlib': (True,
r'''This module provides utilities for common tasks involving the "with"
statement. For more information see also Context Manager Types and
With Statement Context Managers.

'''),
    'contextvars': (True,
r'''This module provides APIs to manage, store, and access context-local
...
'''),
    'copy': (True,
r'''Assignment statements in Python do not copy objects, they create
...
'''),
    'copyreg': (True,
r'''The "copyreg" module offers a way to define functions used while
...
'''),
    'crypt': (False,
r'''crypt is no longer part of the Python standard library. It was removed
in Python 3.13 after being deprecated in Python 3.11.  The removal was
decided in **PEP 594**.
...
'''),
    'csv': (True,
r'''The so-called CSV (Comma Separated Values) format is the most common
...
'''),
    'ctypes': (True,
r'''"ctypes" is a foreign function library for Python.  It provides C
compatible data types, and allows calling functions in DLLs or shared
libraries.  It can be used to wrap these libraries in pure Python.

'''),
    'curses': (True,
r'''The "curses" module provides an interface to the curses library, the
de-facto standard for portable advanced terminal handling.

'''),
    'curses.ascii': (True,
r'''The "curses.ascii" module supplies name constants for ASCII characters
...
'''),
    'curses.panel': (True,
r'''Panels are windows with the added feature of depth, so they can be
...
'''),
    'dataclasses': (True,
r'''This module provides a decorator and functions for automatically
...
'''),
    'datetime': (True,
r'''The "datetime" module supplies classes for manipulating dates and
times.

'''),
    'dbm': (True,
r'''"dbm" is a generic interface to variants of the DBM database:
...
'''),
    'debug': (True,
r'''These libraries help you with Python development: the debugger enables
...
'''),
    'decimal': (True,
r'''The "decimal" module provides support for fast correctly rounded
...
'''),
    'devmode': (True,
r'''The Python Development Mode introduces additional runtime checks that
...
'''),
    'dialog': (True,
r'''The "tkinter.simpledialog" module contains convenience classes and
functions for creating simple modal dialogs to get a value from the
user.

'''),
    'difflib': (True,
r'''This module provides classes and functions for comparing sequences. It
...
'''),
    'dis': (True,
r'''The "dis" module supports the analysis of CPython *bytecode* by
...
'''),
    'distribution': (True,
r'''These libraries help you with publishing and installing Python
...
'''),
    'distutils': (False,
r'''distutils is no longer part of the Python standard library. It was
...
'''),
    'doctest': (True,
r'''The "doctest" module searches for pieces of text that look like
...
'''),
    'email': (True,
r'''The "email" package is a library for managing email messages.  It is
...
'''),
    'email.charset': (True,
r'''This module is part of the legacy ("Compat32") email API.  In the new
API only the aliases table is used.

'''),
    'email.compat32-message': (True,
r'''The "Message" class is very similar to the "EmailMessage" class,
...
'''),
    'email.contentmanager': (True,
r'''Base class for content managers.  Provides the standard registry
...
'''),
    'email.errors': (True,
r'''The following exception classes are defined in the "email.errors"
module:

'''),
    'email.examples': (True,
r'''Here are a few examples of how to use the "email" package to read,
write, and send simple email messages, as well as more complex MIME
messages.

'''),
    'email.generator': (True,
r'''One of the most common tasks is to generate the flat (serialized)
...
'''),
    'email.header': (True,
r'''This module is part of the legacy ("Compat32") email API.  In the
...
'''),
    'email.headerregistry': (True,
r'''Headers are represented by customized subclasses of "str".  The
...
'''),
    'email.iterators': (True,
r'''Iterating over a message object tree is fairly easy with the
"Message.walk" method.  The "email.iterators" module provides some
useful higher level iterations over message object trees.

'''),
    'email.message': (True,
r'''The central class in the "email" package is the "EmailMessage" class,
...
'''),
    'email.mime': (True,
r'''This module is part of the legacy ("Compat32") email API.  Its
...
'''),
    'email.parser': (True,
r'''Message object structures can be created in one of two ways: they can
...
'''),
    'email.policy': (True,
r'''The "email" package’s prime focus is the handling of email messages as
...
'''),
    'email.utils': (True,
r'''There are a couple of useful utilities provided in the "email.utils"
module:

'''),
    'ensurepip': (True,
r'''The "ensurepip" package provides support for bootstrapping the "pip"
...
'''),
    'enum': (True,
r'''This page contains the API reference information. For tutorial
information and discussion of more advanced topics, see

'''),
    'errno': (True,
r'''This module makes available standard "errno" system symbols. The value
...
'''),
    'exceptions': (True,
r'''In Python, all exceptions must be instances of a class that derives
...
'''),
    'faulthandler': (True,
r'''This module contains functions to dump Python tracebacks explicitly,
...
'''),
    'fractions': (True,
r'''The "fractions" module provides support for rational number
arithmetic.

'''),
    'ftplib': (True,
r'''This module defines the class "FTP" and a few related items. The "FTP"
...
'''),
    'functions': (True,
r'''The Python interpreter has a number of functions and types built into
it that are always available.  They are listed here in alphabetical
order.

'''),
    'functools': (True,
r'''The "functools" module is for higher-order functions: functions that
...
'''),
    'gc': (True,
r'''This module provides an interface to the optional garbage collector.
...
'''),
    'getopt': (True,
r'''This module is considered feature complete. A more declarative and
...
'''),
    'getpass': (True,
r'''Availability: not WASI.

'''),
    'gettext': (True,
r'''The "gettext" module provides internationalization (I18N) and
...
'''),
    'glob': (True,
r'''The "glob" module finds all the pathnames matching a specified pattern
...
'''),
    'graphlib': (True,
r'''Provides functionality to topologically sort a graph of *hashable*
nodes.

'''),
    'grp': (True,
r'''This module provides access to the Unix group database. It is
available on all Unix versions.

'''),
    'gzip': (True,
r'''This module provides a simple interface to compress and decompress
files just like the GNU programs **gzip** and **gunzip** would.

'''),
    'hashlib': (True,
r'''This module implements a common interface to many different hash
...
'''),
    'heapq': (True,
r'''This module provides an implementation of the heap queue algorithm,
also known as the priority queue algorithm.

'''),
    'hmac': (True,
r'''This module implements the HMAC algorithm as described by **RFC
...
'''),
    'html': (True,
r'''This module defines utilities to manipulate HTML.

'''),
    'html.entities': (True,
r'''This module defines four dictionaries, "html5", "name2codepoint",
"codepoint2name", and "entitydefs".

'''),
    'html.parser': (True,
r'''This module defines a class "HTMLParser" which serves as the basis for
parsing text files formatted in HTML (HyperText Mark-up Language) and
XHTML.

'''),
    'http': (True,
r'''"http" is a package that collects several modules for working with the
...
'''),
    'http.client': (True,
r'''This module defines classes that implement the client side of the HTTP
...
'''),
    'http.cookiejar': (True,
r'''The "http.cookiejar" module defines classes for automatic handling of
...
'''),
    'http.cookies': (True,
r'''The "http.cookies" module defines classes for abstracting the concept
...
'''),
    'http.server': (True,
r'''This module defines classes for implementing HTTP servers.

'''),
    'idle': (True,
r'''IDLE is Python’s Integrated Development and Learning Environment.

'''),
    'imaplib': (True,
r'''This module defines three classes, "IMAP4", "IMAP4_SSL" and
...
'''),
    'imghdr': (False,
r'''imghdr is no longer part of the Python standard library. It was
removed in Python 3.13 after being deprecated in Python 3.11.  The
removal was decided in **PEP 594**.
...
'''),
    'imp': (False,
r'''imp is no longer part of the Python standard library. It was removed
...
'''),
    'importlib': (True,
r'''The purpose of the "importlib" package is three-fold.

'''),
    'importlib.metadata': (True,
r'''Changed in version 3.10: "importlib.metadata" is no longer
provisional.

'''),
    'importlib.resources': (True,
r'''This module leverages Python’s import system to provide access to
*resources* within *packages*.

'''),
    'importlib.resources.abc': (True,
r'''*Superseded by TraversableResources*

'''),
    'index': (True,
r'''While The Python Language Reference describes the exact syntax and
...
'''),
    'inspect': (True,
r'''The "inspect" module provides several useful functions to help get
...
'''),
    'intro': (True,
r'''The “Python library” contains several different kinds of components.

'''),
    'io': (True,
r'''The "io" module provides Python’s main facilities for dealing with
...
'''),
    'ipaddress': (True,
r'''"ipaddress" provides the capabilities to create, manipulate and
operate on IPv4 and IPv6 addresses and networks.

'''),
    'itertools': (True,
r'''This module implements a number of *iterator* building blocks inspired
by constructs from APL, Haskell, and SML.  Each has been recast in a
form suitable for Python.

'''),
    'json': (True,
r'''JSON (JavaScript Object Notation), specified by **RFC 7159** (which
...
'''),
    'keyword': (True,
r'''This module allows a Python program to determine if a string is a
keyword or soft keyword.

'''),
    'language': (True,
r'''Python provides a number of modules to assist in working with the
...
'''),
    'linecache': (True,
r'''The "linecache" module allows one to get any line from a Python source
...
'''),
    'locale': (True,
r'''The "locale" module opens access to the POSIX locale database and
...
'''),
    'logging.config': (True,
r'''This page contains only reference information. For tutorials, please
see
...
'''),
    'lzma': (True,
r'''This module provides classes and convenience functions for compressing
...
'''),
    'mailbox': (True,
r'''This module defines two classes, "Mailbox" and "Message", for
...
'''),
    'mailcap': (False,
r'''mailcap is no longer part of the Python standard library. It was
removed in Python 3.13 after being deprecated in Python 3.11.  The
removal was decided in **PEP 594**.
...
'''),
    'markup': (True,
r'''Python supports a variety of modules to work with various forms of
...
'''),
    'marshal': (True,
r'''This module contains functions that can read and write Python values
...
'''),
    'math': (True,
r'''This module provides access to common mathematical functions and
constants, including those defined by the C standard.

'''),
    'mimetypes': (True,
r'''The "mimetypes" module converts between a filename or URL and the MIME
...
'''),
    'modulefinder': (True,
r'''This module provides a "ModuleFinder" class that can be used to
...
'''),
    'msilib': (False,
r'''msilib is no longer part of the Python standard library. It was
removed in Python 3.13 after being deprecated in Python 3.11.  The
removal was decided in **PEP 594**.
...
'''),
    'msvcrt': (True,
r'''These functions provide access to some useful capabilities on Windows
...
r'''Availability: not Android, not iOS, not WASI.

'''),
    'multiprocessing.shared_memory': (True,
r'''This module provides a class, "SharedMemory", for the allocation and
...
'''),
    'netdata': (True,
r'''This chapter describes modules which support handling data formats
commonly used on the internet.

'''),
    'netrc': (True,
r'''The "netrc" class parses and encapsulates the netrc file format used
by the Unix **ftp** program and other FTP clients.

'''),
    'nis': (False,
r'''nis is no longer part of the Python standard library. It was removed
in Python 3.13 after being deprecated in Python 3.11.  The removal was
decided in **PEP 594**.
...
'''),
    'nntplib': (False,
r'''nntplib is no longer part of the Python standard library. It was
removed in Python 3.13 after being deprecated in Python 3.11.  The
removal was decided in **PEP 594**.
...
'''),
    'numbers': (True,
r'''The "numbers" module (**PEP 3141**) defines a hierarchy of numeric
...
'''),
    'operator': (True,
r'''The "operator" module exports a set of efficient functions
...
'''),
    'optparse': (True,
r'''The standard library includes three argument parsing libraries:
...
'''),
    'os': (True,
r'''This module provides a portable way of using operating system
...
'''),
    'os.path': (True,
r'''This module implements some useful functions on pathnames. To read or
...
'''),
    'ossaudiodev': (False,
r'''ossaudiodev is no longer part of the Python standard library. It was
removed in Python 3.13 after being deprecated in Python 3.11.  The
removal was decided in **PEP 594**.
...
'''),
    'pathlib': (True,
r'''This module offers classes representing filesystem paths with
...
'''),
    'pdb': (True,
r'''The module "pdb" defines an interactive source code debugger for
Python programs.  It supports setting (conditional) breakpoints and
single stepping at the source line level, inspection of stack frames,
source code listing, and evaluation of arbitrary Python code in the
context of any stack frame.  It also supports post-mortem debugging
...
'''),
    'pickle': (True,
r'''The "pickle" module implements binary protocols for serializing and
...
'''),
    'pickletools': (True,
r'''This module contains various constants relating to the intimate
...
'''),
    'pipes': (False,
r'''pipes is no longer part of the Python standard library. It was removed
in Python 3.13 after being deprecated in Python 3.11.  The removal was
decided in **PEP 594**.
...
'''),
    'pkgutil': (True,
r'''This module provides utilities for the import system, in particular
package support.

'''),
    'platform': (True,
r'''Specific platforms listed alphabetically, with Linux included in the
Unix section.

'''),
    'plistlib': (True,
r'''This module provides an interface for reading and writing the
“property list” files used by Apple, primarily on macOS and iOS. This
module supports both binary and XML plist files.

'''),
    'poplib': (True,
r'''This module defines a class, "POP3", which encapsulates a connection
...
'''),
    'posix': (True,
r'''This module provides access to operating system functionality that is
standardized by the C Standard and the POSIX standard (a thinly
disguised Unix interface).

'''),
    'pprint': (True,
r'''The "pprint" module provides a capability to “pretty-print” arbitrary
...
'''),
    'profile': (True,
r'''Python provides both *statistical profiling* and *deterministic
...
'''),
    'pty': (True,
r'''The "pty" module defines operations for handling the pseudo-terminal
concept: starting another process and being able to write to and read
from its controlling terminal programmatically.

'''),
    'pwd': (True,
r'''This module provides access to the Unix user account and password
database.  It is available on all Unix versions.

'''),
    'py_compile': (True,
r'''The "py_compile" module provides a function to generate a byte-code
file from a source file, and another function used when the module
source file is invoked as a script.

'''),
    'pyclbr': (True,
r'''The "pyclbr" module provides limited information about the functions,
...
'''),
    'pydoc': (True,
r'''The "pydoc" module automatically generates documentation from Python
modules.  The documentation can be presented as pages of text on the
console, served to a web browser, or saved to HTML files.

'''),
    'pyexpat': (True,
r'''If you need to parse untrusted or unauthenticated data, see XML
security.

'''),
    'queue': (True,
r'''The "queue" module implements multi-producer, multi-consumer queues.
...
'''),
    'quopri': (True,
r'''This module performs quoted-printable transport encoding and decoding,
...
'''),
    'random': (True,
r'''This module implements pseudo-random number generators for various
distributions.

'''),
    're': (True,
r'''This module provides regular expression matching operations similar to
those found in Perl.

'''),
    'readline': (True,
r'''The "readline" module defines a number of functions to facilitate
...
'''),
    'reprlib': (True,
r'''The "reprlib" module provides a means for producing object
...
'''),
    'resource': (True,
r'''This module provides basic mechanisms for measuring and controlling
system resources utilized by a program.

'''),
    'rlcompleter': (True,
r'''The "rlcompleter" module defines a completion function suitable to be
passed to "set_completer()" in the "readline" module.

'''),
    'runpy': (True,
r'''The "runpy" module is used to locate and run Python modules without
...
'''),
    'sched': (True,
r'''The "sched" module defines a class which implements a general purpose
event scheduler:

'''),
    'secrets': (True,
r'''The "secrets" module is used for generating cryptographically strong
random numbers suitable for managing data such as passwords, account
authentication, security tokens, and related secrets.

'''),
    'security_warnings': (True,
r'''The following modules have specific security considerations:
...
'''),
    'select': (True,
r'''This module provides access to the "select()" and "poll()" functions
...
'''),
    'selectors': (True,
r'''This module allows high-level and efficient I/O multiplexing, built
...
'''),
    'shelve': (True,
r'''A “shelf” is a persistent, dictionary-like object.  The difference
...
'''),
    'shlex': (True,
r'''The "shlex" class makes it easy to write lexical analyzers for simple
...
'''),
    'shutil': (True,
r'''The "shutil" module offers a number of high-level operations on files
...
'''),
    'site': (True,
r'''**This module is automatically imported during initialization.** The
automatic import can be suppressed using the interpreter’s "-S"
option.

'''),
    'smtpd': (False,
r'''smtpd is no longer part of the Python standard library. It was removed
...
'''),
    'smtplib': (True,
r'''The "smtplib" module defines an SMTP client session object that can be
...
'''),
    'sndhdr': (False,
r'''sndhdr is no longer part of the Python standard library. It was
removed in Python 3.13 after being deprecated in Python 3.11.  The
removal was decided in **PEP 594**.
...
'''),
    'socket': (True,
r'''This module provides access to the BSD *socket* interface. It is
available on all modern Unix systems, Windows, MacOS, and probably
additional platforms.

'''),
    'socketserver': (True,
r'''The "socketserver" module simplifies the task of writing network
servers.

'''),
    'spwd': (False,
r'''spwd is no longer part of the Python standard library. It was removed
in Python 3.13 after being deprecated in Python 3.11.  The removal was
decided in **PEP 594**.
...
'''),
    'sqlite3': (True,
r'''SQLite is a C library that provides a lightweight disk-based database
...
'''),
    'ssl': (True,
r'''This module provides access to Transport Layer Security (often known
...
'''),
    'stat': (True,
r'''The "stat" module defines constants and functions for interpreting the
...
'''),
    'statistics': (True,
r'''This module provides functions for calculating mathematical statistics
of numeric ("Real"-valued) data.

'''),
    'stdtypes': (True,
r'''The following sections describe the standard types that are built into
the interpreter.

'''),
    'string': (True,
r'''Text Sequence Type — str

'''),
    'string.templatelib': (True,
r'''Format strings

'''),
    'stringprep': (True,
r'''When identifying things (such as host names) in the internet, it is
...
'''),
    'struct': (True,
r'''This module converts between Python values and C structs represented
...
'''),
    'subprocess': (True,
r'''The "subprocess" module allows you to spawn new processes, connect to
...
'''),
    'sunau': (False,
r'''sunau is no longer part of the Python standard library. It was removed
in Python 3.13 after being deprecated in Python 3.11.  The removal was
decided in **PEP 594**.
...
'''),
    'symtable': (True,
r'''Symbol tables are generated by the compiler from AST just before
...
'''),
    'sys': (True,
r'''This module provides access to some variables used or maintained by
...
'''),
    'sys.monitoring': (True,
r'''"sys.monitoring" is a namespace within the "sys" module, not an
independent module, so there is no need to "import sys.monitoring",
simply "import sys" and then use "sys.monitoring".

'''),
    'sys_path_init': (True,
r'''A module search path is initialized when Python starts. This module
search path may be accessed at "sys.path".

'''),
    'sysconfig': (True,
r'''The "sysconfig" module provides access to Python’s configuration
information like the list of installation paths and the configuration
variables relevant for the current platform.

'''),
    'syslog': (True,
r'''This module provides an interface to the Unix "syslog" library
routines. Refer to the Unix manual pages for a detailed description of
the "syslog" facility.

'''),
    'tabnanny': (True,
r'''For the time being this module is intended to be called as a script.
However it is possible to import it into an IDE and use the function
"check()" described below.

'''),
    'tarfile': (True,
r'''The "tarfile" module makes it possible to read and write tar archives,
...
'''),
    'telnetlib': (False,
r'''telnetlib is no longer part of the Python standard library. It was
removed in Python 3.13 after being deprecated in Python 3.11.  The
removal was decided in **PEP 594**.
...
'''),
    'tempfile': (True,
r'''This module creates temporary files and directories.  It works on all
...
'''),
    'termios': (True,
r'''This module provides an interface to the POSIX calls for tty I/O
...
'''),
    'test': (True,
r'''The "test" package is meant for internal use by Python only. It is
...
'''),
    'textwrap': (True,
r'''The "textwrap" module provides some convenience functions, as well as
...
'''),
    'threading': (True,
r'''This module constructs higher-level threading interfaces on top of the
lower level "_thread" module.

'''),
    'time': (True,
r'''This module provides various time-related functions. For related
functionality, see also the "datetime" and "calendar" modules.

'''),
    'timeit': (True,
r'''This module provides a simple way to time small bits of Python code.
...
'''),
    'tk': (True,
r'''Tk/Tcl has long been an integral part of Python.  It provides a robust
...
'''),
    'tkinter': (True,
r'''The "tkinter" package (“Tk interface”) is the standard Python
...
'''),
    'tkinter.colorchooser': (True,
r'''The "tkinter.colorchooser" module provides the "Chooser" class as an
...
'''),
    'tkinter.dnd': (True,
r'''This is experimental and due to be deprecated when it is replaced with
the Tk DND.

'''),
    'tkinter.font': (True,
r'''The "tkinter.font" module provides the "Font" class for creating and
using named fonts.

'''),
    'tkinter.messagebox': (True,
r'''The "tkinter.messagebox" module provides a template base class as well
...
'''),
    'tkinter.scrolledtext': (True,
r'''The "tkinter.scrolledtext" module provides a class of the same name
...
'''),
    'tkinter.ttk': (True,
r'''The "tkinter.ttk" module provides access to the Tk themed widget set,
...
'''),
    'token': (True,
r'''This module provides constants which represent the numeric values of
...
'''),
    'tokenize': (True,
r'''The "tokenize" module provides a lexical scanner for Python source
...
'''),
    'tomllib': (True,
r'''This module provides an interface for parsing TOML 1.0.0 (Tom’s
Obvious Minimal Language, https://toml.io). This module does not
support writing TOML.

'''),
    'trace': (True,
r'''The "trace" module allows you to trace program execution, generate
...
'''),
    'traceback': (True,
r'''This module provides a standard interface to extract, format and print
...
'''),
    'tracemalloc': (True,
r'''The tracemalloc module is a debug tool to trace memory blocks
...
'''),
    'tty': (True,
r'''The "tty" module defines functions for putting the tty into cbreak and
raw modes.

'''),
    'turtle': (True,
r'''Turtle graphics is an implementation of the popular geometric drawing
tools introduced in Logo, developed by Wally Feurzeig, Seymour Papert
and Cynthia Solomon in 1967.

'''),
    'types': (True,
r'''This module defines utility functions to assist in dynamic creation of
new types.

'''),
    'typing': (True,
r'''The Python runtime does not enforce function and variable type
annotations. They can be used by third party tools such as *type
checkers*, IDEs, linters, etc.

'''),
    'unicodedata': (True,
r'''This module provides access to the Unicode Character Database (UCD)
...
'''),
    'unittest': (True,
r'''(If you are already familiar with the basic concepts of testing, you
might want to skip to the list of assert methods.)

'''),
    'unittest.mock': (True,
r'''"unittest.mock" is a library for testing in Python. It allows you to
replace parts of your system under test with mock objects and make
assertions about how they have been used.

'''),
    'unittest.mock-examples': (True,
r'''Common uses for "Mock" objects include:
...
'''),
    'urllib': (True,
r'''"urllib" is a package that collects several modules for working with
URLs:
...
'''),
    'urllib.error': (True,
r'''The "urllib.error" module defines the exception classes for exceptions
raised by "urllib.request".  The base exception class is "URLError".

'''),
    'urllib.parse': (True,
r'''This module defines a standard interface to break Uniform Resource
...
'''),
    'urllib.request': (True,
r'''The "urllib.request" module defines functions and classes which help
in opening URLs (mostly HTTP) in a complex world — basic and digest
authentication, redirections, cookies and more.

'''),
    'urllib.robotparser': (True,
r'''This module provides a single class, "RobotFileParser", which answers
...
'''),
    'uu': (False,
r'''uu is no longer part of the Python standard library. It was removed in
...
'''),
    'uuid': (True,
r'''This module provides immutable "UUID" objects (the "UUID" class) and
...
'''),
    'venv': (True,
r'''The "venv" module supports creating lightweight “virtual
...
'''),
    'warnings': (True,
r'''Warning messages are typically issued in situations where it is useful
...
'''),
    'wave': (True,
r'''The "wave" module provides a convenient interface to the Waveform
Audio “WAVE” (or “WAV”) file format. Only uncompressed PCM encoded
wave files are supported.

'''),
    'weakref': (True,
r'''The "weakref" module allows the Python programmer to create *weak
references* to objects.

'''),
    'webbrowser': (True,
r'''The "webbrowser" module provides a high-level interface to allow
...
'''),
    'windows': (True,
r'''This chapter describes modules that are only available on MS Windows
platforms.

'''),
    'winreg': (True,
r'''These functions expose the Windows registry API to Python.  Instead of
...
'''),
    'winsound': (True,
r'''The "winsound" module provides access to the basic sound-playing
machinery provided by Windows platforms.  It includes functions and
several constants.

'''),
    'wsgiref': (True,
r'''The Web Server Gateway Interface (WSGI) is a standard interface
...
'''),
    'xdrlib': (False,
r'''xdrlib is no longer part of the Python standard library. It was
removed in Python 3.13 after being deprecated in Python 3.11.  The
removal was decided in **PEP 594**.
...
'''),
    'xml': (True,
r'''Python’s interfaces for processing XML are grouped in the "xml"
package.

'''),
    'xml.dom': (True,
r'''The Document Object Model, or “DOM,” is a cross-language API from the
...
r'''"xml.dom.minidom" is a minimal implementation of the Document Object
...
r'''The "xml.dom.pulldom" module provides a “pull parser” which can also
...
r'''The "xml.etree.ElementTree" module implements a simple and efficient
API for parsing and creating XML data.

'''),
    'xml.sax': (True,
r'''The "xml.sax" package provides a number of modules which implement the
...
r'''The SAX API defines five kinds of handlers: content handlers, DTD
...
'''),
    'xml.sax.reader': (True,
r'''SAX parsers implement the "XMLReader" interface. They are implemented
...
'''),
    'xml.sax.utils': (True,
r'''The module "xml.sax.saxutils" contains a number of classes and
functions that are commonly useful when creating SAX applications,
either in direct use, or as base classes.

'''),
    'xmlrpc': (True,
r'''XML-RPC is a Remote Procedure Call method that uses XML passed via
...
'''),
    'xmlrpc.server': (True,
r'''The "xmlrpc.server" module provides a basic server framework for XML-
...
'''),
    'zipapp': (True,
r'''This module provides tools to manage the creation of zip files
...
'''),
    'zipfile': (True,
r'''The ZIP file format is a common archive and compression standard. This
...
'''),
    'zipimport': (True,
r'''This module adds the ability to import Python modules ("*.py",
...
'''),
    'zlib': (True,
r'''For applications that require data compression, the functions in this
...
'''),
    'zoneinfo': (True,
r'''The "zoneinfo" module provides a concrete time zone implementation to
