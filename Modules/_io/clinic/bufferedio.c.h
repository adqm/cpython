...
#define _IO__BUFFERED_READLINE_METHODDEF    \
    {"readline", _PyCFunction_CAST(_io__Buffered_readline), METH_FASTCALL|METH_KEYWORDS, _io__Buffered_readline__doc__},

static PyObject *
_io__Buffered_readline_impl(buffered *self, Py_ssize_t size, int close);

static PyObject *
_io__Buffered_readline(PyObject *self, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    PyObject *return_value = NULL;
    #if defined(Py_BUILD_CORE) && !defined(Py_BUILD_CORE_MODULE)
...
skip_optional_kwonly:
    Py_BEGIN_CRITICAL_SECTION(self);
    return_value = _io__Buffered_readline_impl((buffered *)self, size, close);
    Py_END_CRITICAL_SECTION();
...
/*[clinic end generated code: output=52f290686dbe73ae input=a9049054013a1b77]*/
