...
#define _IO_STRINGIO_READ_METHODDEF    \
    {"read", _PyCFunction_CAST(_io_StringIO_read), METH_FASTCALL|METH_KEYWORDS, _io_StringIO_read__doc__},

static PyObject *
_io_StringIO_read_impl(stringio *self, Py_ssize_t size, int close);

static PyObject *
_io_StringIO_read(PyObject *self, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    PyObject *return_value = NULL;
    #if defined(Py_BUILD_CORE) && !defined(Py_BUILD_CORE_MODULE)
...
skip_optional_kwonly:
    Py_BEGIN_CRITICAL_SECTION(self);
    return_value = _io_StringIO_read_impl((stringio *)self, size, close);
    Py_END_CRITICAL_SECTION();
...
/*[clinic end generated code: output=21c83060f5cbb791 input=a9049054013a1b77]*/
